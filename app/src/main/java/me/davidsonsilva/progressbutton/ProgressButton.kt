...
import me.davidsonsilva.progressbutton.databinding.ProgressButtonBinding
...
class ProgressButton @JvmOverloads constructor(
    ...
    private val binding = ProgressButtonBinding.inflate(LayoutInflater.from(context),
        this, true)

    private var state:ProgressButtonState = ProgressButtonState.Active
    set(value) {
        field = value
        refreshState()
    }
    ...
    private fun refreshState() {
        ...
        when(state){
            ProgressButtonState.Active -> binding.textTitle.text = title
